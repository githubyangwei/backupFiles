...
if($('#sidebar dl').find('.sub').length>0){$('#sidebar dl dt a ').addClass('ddl');}
	if(dom){
		dom.hover(function(){
			$(this).addClass(lei);
			if(type==1){
...
$(".index-product ol li a.img img").height($(".index-product ol li a.img img").height());			$('#car_prev,#car_next').css('top','40%');
$('#trigger').hide();
